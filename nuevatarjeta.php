          ...
          <div class="mb-4">
            <div class="row align-items-center">
              <div class="col-md-6 col-lg-5">
                <h4 class="mb-8 breadcrumb-title"><span class="text-primary">Tarjetas - idtarjeta</span>
                </h4>
          ...
          <div class="card">
            <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3" id="pills-carga-tab" data-bs-toggle="pill" data-bs-target="#pills-carga" type="button" role="tab" aria-controls="pills-notifications" aria-selected="false">
                  <i class="ti ti-bell me-2 fs-6"></i>
                  <span class="d-none d-md-block">Carga de saldo</span>
                </button>
              </li>
            ...
            <div class="card-body">
              <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade " id="pills-carga" role="tabpanel" aria-labelledby="pills-notifications-tab" tabindex="0">
                    <div class="row justify-content-center">
                      <div class="col-lg-9">
                        <div class="card border shadow-none">
                          <div class="card-body p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-7 mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                      ...
                                      <div>
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="$" value="$0.0" required="">
                                      </div>
                                    </div>
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <button class="btn btn-primary">Asignar monto</button>
                                    <button class="btn btn-danger">Retirar monto</button>
                                  </div>
