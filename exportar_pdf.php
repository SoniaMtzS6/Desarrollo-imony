<?php
// NOTA: Esto es una simulación de PDF. El navegador descargará un archivo .pdf pero será HTML, no un PDF real.
...
header('Content-Disposition: attachment;filename="reporte_empresa.html"');
echo '<p><b>Para guardar como PDF, abre este archivo en tu navegador y usa la opción Imprimir &gt; Guardar como PDF.</b></p>';
echo '<h2>Reporte de Empresa</h2>';
