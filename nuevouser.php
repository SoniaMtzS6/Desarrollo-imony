  ...
  if (isset($data['data'][0])) {
      ...
      if ($_SESSION["usuario"]["perfil"] === "Superadministrador") {
          ...
          foreach ($data['data'] as $user) {
              ...
              if ($_SESSION["usuario"]["idEmpresa"] == $idEmpresa) {
...
try {
    ...
    if ($_SESSION["usuario"]["perfil"] === "Superadministrador") {
        // Si es superadmin, mostrar todas las empresas
        $query = "SELECT ID_EMPRESA, NOMBRE_EMPRESA FROM empresas ORDER BY NOMBRE_EMPRESA ASC";
        $result = $conn->query($query);
        
        while ($row = $result->fetch_assoc()) {
            $empresa .= '<option value="' . $row['ID_EMPRESA'] . '">' . $row['NOMBRE_EMPRESA'] . '</option>';
        }
    } else {
        // Si no es superadmin, mostrar solo su empresa
        $id_empresa = $_SESSION["usuario"]["id_empresa"];
        $query = "SELECT ID_EMPRESA, NOMBRE_EMPRESA FROM empresas WHERE ID_EMPRESA = ?";
...
<body class="link-sidebar">
                    ...
                    <div class="col-12">
                      <div class="card w-100 border position-relative overflow-hidden mb-0">
                        <div class="card-body p-4">
                          ...
                          <form action="servicios/cargaruser.php" method="post">
                            <div class="row">
                              <div class="col-lg-6">
                                <div class="mb-3">
                                  <label for="exampleInputtext" class="form-label">Nombre</label>
                                  <input type="text" name="nombre" id="nombre" class="form-control" id="exampleInputtext" placeholder="Mike Nielsen">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                  ...
                                  <input name="email" type="email" class="form-control" id="exampleInputtext1" placeholder="info@interestellar.com">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputtext2" class="form-label" hidden>Identificador (solo lectura)</label>
                                    <input name="rfc" type="number" class="form-control" id="exampleInputtext2" placeholder="Identificador" value="<?php echo $codigo; ?>" hidden>
                                  </div>
                                  <div class="mb-3">
                                    <label for="exampleInputtext2" class="form-label">Codigo postal</label>
                                    <input name="cp" type="number" class="form-control" id="cp" placeholder="CP" maxlength="5">
                                  </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputtext2" class="form-label">Fecha de nacimiento</label>
                                    <input name="fecha" type="date" class="form-control" id="exampleInputtext2" placeholder="empresa">
                                  </div>
                                <div class="mb-3">
                                  <label for="exampleInputtext3" class="form-label">Telefono</label>
                                  <input name="phone" type="text" class="form-control" id="phone" maxlength="10" placeholder="5534516547">
                                </div>
                              ...
                              <div class="col-12">
                                ...
                                <div>
                                  ...
                                  <input  name="direccion" type="text" class="form-control" id="exampleInputtext4" placeholder="814 Howard Street, 120065, mexico">
                                </div>
                              </div>
                              <div class="col-12">
  ...
  <script>
      ...
      // Evitar escribir espacios
      phoneInput.addEventListener("keydown", function(e) {
        if (e.key === " " || isNaN(e.key) && e.key !== "Backspace" && e.key !== "ArrowLeft" && e.key !== "ArrowRight") {
          e.preventDefault();
        }
      });

      // Eliminar cualquier espacio o carácter no numérico pegado
